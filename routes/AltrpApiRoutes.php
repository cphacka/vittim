...
Route::get('/startups', ['middleware' => ['auth:api','role:admin'], 'uses' =>'AltrpControllers\startupController@index']);
Route::get('/startup_options', ['middleware' => ['auth:api','role:admin'], 'uses' =>'AltrpControllers\startupController@options']);
Route::post('/startups', ['middleware' => ['auth:api','role:admin'], 'uses' =>'AltrpControllers\startupController@store']);
Route::get('/startups/{startup}', ['middleware' => ['auth:api','role:admin'], 'uses' =>'AltrpControllers\startupController@show']);
...
Route::post('/startup_branches', ['middleware' => ['auth:api','role:admin'], 'uses' =>'AltrpControllers\startup_branchController@store']);
...
Route::post('/startup_technologies', ['middleware' => ['auth:api','role:admin'], 'uses' =>'AltrpControllers\startup_technologyController@store']);
