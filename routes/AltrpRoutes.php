...
Route::get('/pilot_identifications/customizers/get_pilot_identification_yyjuggvcq', ['uses' =>'AltrpControllers\pilot_identificationController@get_pilot_identification_yyjuggvcq']);
...
Route::get('/pilot_effects/customizers/get_pilot_effect_z1eaytb3d', ['uses' =>'AltrpControllers\pilot_effectController@get_pilot_effect_z1eaytb3d']);
...
Route::get('/pilot_stages/customizers/get_pilot_stage_z7e7hxkt2', ['uses' =>'AltrpControllers\pilot_stageController@get_pilot_stage_z7e7hxkt2']);
...
Route::get('/pilot_budgets/customizers/get_pilot_budget_p4illuscr', ['uses' =>'AltrpControllers\pilot_budgetController@get_pilot_budget_p4illuscr']);
...
Route::get('/pilot_events/customizers/get_pilot_event_ungwn7t35', ['uses' =>'AltrpControllers\pilot_eventController@get_pilot_event_ungwn7t35']);
...
Route::get('/queries/branches/select_branches', ['uses' =>'AltrpControllers\branchController@select_branches']);
Route::get('/branches/customizers/get_branch_p51du0t4y', ['uses' =>'AltrpControllers\branchController@get_branch_p51du0t4y']);
Route::put('/branches/customizers/put_branch_76xmem8oz', ['uses' =>'AltrpControllers\branchController@put_branch_76xmem8oz']);
Route::post('/branches/customizers/add_branch_86nfuuq0r', ['uses' =>'AltrpControllers\branchController@add_branch_86nfuuq0r']);
Route::delete('/branches/customizers/delete_branch_y6rgo52r0', ['uses' =>'AltrpControllers\branchController@delete_branch_y6rgo52r0']);
...
Route::post('/startup_branches/customizers/add_startup_branch_d6v2m4qjb', ['uses' =>'AltrpControllers\startup_branchController@add_startup_branch_d6v2m4qjb']);
...
Route::post('/startup_technologies/customizers/add_startup_technology_sa4zzlri7', ['uses' =>'AltrpControllers\startup_technologyController@add_startup_technology_sa4zzlri7']);
...
Route::get('/status_stages/customizers/get_status_stage_wdr2jmedu', ['uses' =>'AltrpControllers\status_stageController@get_status_stage_wdr2jmedu']);
Route::put('/status_stages/customizers/put_status_stage_bp6481z3d', ['uses' =>'AltrpControllers\status_stageController@put_status_stage_bp6481z3d']);
Route::post('/status_stages/customizers/add_status_stage_324e7776k', ['uses' =>'AltrpControllers\status_stageController@add_status_stage_324e7776k']);
Route::delete('/status_stages/customizers/delete_status_stage_4x4asmmb1', ['uses' =>'AltrpControllers\status_stageController@delete_status_stage_4x4asmmb1']);
...
Route::get('/status_readies/customizers/get_status_ready_nygm9ups1', ['uses' =>'AltrpControllers\status_readyController@get_status_ready_nygm9ups1']);
Route::put('/status_readies/customizers/put_status_ready_4w6v98mak', ['uses' =>'AltrpControllers\status_readyController@put_status_ready_4w6v98mak']);
Route::post('/status_readies/customizers/add_status_ready_yxmricent', ['uses' =>'AltrpControllers\status_readyController@add_status_ready_yxmricent']);
Route::delete('/status_readies/customizers/delete_status_ready_59w1yq0b1', ['uses' =>'AltrpControllers\status_readyController@delete_status_ready_59w1yq0b1']);
...
Route::get('/pilot_meetings/customizers/get_pilot_meeting_ic4j9f8cp', ['uses' =>'AltrpControllers\pilot_meetingController@get_pilot_meeting_ic4j9f8cp']);
...
Route::get('/flow_types/customizers/get_flow_type_7hlblvkob', ['uses' =>'AltrpControllers\flow_typeController@get_flow_type_7hlblvkob']);
Route::post('/flow_types/customizers/add_flow_type_ns7ghls4v', ['uses' =>'AltrpControllers\flow_typeController@add_flow_type_ns7ghls4v']);
Route::delete('/flow_types/customizers/delete_flow_type_7hbs0jjiw', ['uses' =>'AltrpControllers\flow_typeController@delete_flow_type_7hbs0jjiw']);
Route::put('/flow_types/customizers/put_flow_type_tgxddnlae', ['uses' =>'AltrpControllers\flow_typeController@put_flow_type_tgxddnlae']);
...
Route::get('/pilot_files/customizers/get_pilot_file_9mhbpr49n', ['uses' =>'AltrpControllers\pilot_fileController@get_pilot_file_9mhbpr49n']);
...
Route::get('/count_people/customizers/get_count_person_r21333740', ['uses' =>'AltrpControllers\count_personController@get_count_person_r21333740']);
Route::put('/count_people/customizers/put_count_person_0ftuuipnf', ['uses' =>'AltrpControllers\count_personController@put_count_person_0ftuuipnf']);
Route::post('/count_people/customizers/add_count_person_7145a74cf', ['uses' =>'AltrpControllers\count_personController@add_count_person_7145a74cf']);
Route::delete('/count_people/customizers/delete_count_person_nmulzoztk', ['uses' =>'AltrpControllers\count_personController@delete_count_person_nmulzoztk']);
...
Route::get('/org_branches/customizers/get_org_branch_wrnrx8mwh', ['uses' =>'AltrpControllers\org_branchController@get_org_branch_wrnrx8mwh']);
Route::put('/org_branches/customizers/put_org_branch_9q14fd0qu', ['uses' =>'AltrpControllers\org_branchController@put_org_branch_9q14fd0qu']);
Route::post('/org_branches/customizers/add_org_branch_sihqrhirf', ['uses' =>'AltrpControllers\org_branchController@add_org_branch_sihqrhirf']);
Route::delete('/org_branches/customizers/delete_org_branch_h9e4idaho', ['uses' =>'AltrpControllers\org_branchController@delete_org_branch_h9e4idaho']);
