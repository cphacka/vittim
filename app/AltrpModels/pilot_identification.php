...
class pilot_identification extends Model
{
    ...
    * @var string
    */
    protected $table = 'pilot_identifications';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['pilot_project_id','organization','student','coordinator','description','expiration_date','text','name_project'];
    ...
    {
        return $this->belongsTo('App\AltrpModels\pilot_project', 'pilot_project_id', 'id');
    }
