...
class comment extends Model
{
    ...
    */
    ...
    {
        return $this->hasMany('App\AltrpModels\comment_startup', 'comment_id', 'id');
    }

    public function comment_pilot()
    {
        return $this->hasMany('App\AltrpModels\comment_pilot', 'comment_id', 'id');
    }

    public function comment_startup_news()
    {
        return $this->hasMany('App\AltrpModels\comment_startup_news', 'comment_id', 'id');
    }
