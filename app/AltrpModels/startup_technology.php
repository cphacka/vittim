...
class startup_technology extends Model
{
    ...
    * @var string
    */
    protected $table = 'startup_technologies';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['startup_id','technology_id'];
    ...
    {
        return $this->belongsTo('App\AltrpModels\technology', 'technology_id', 'id');
    }
