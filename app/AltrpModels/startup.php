...
class startup extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['name','status_stage_id','description','status_sertificate','contact_fio','contact_person','legal_name','legal_inn','site_url','rank','media_id','cases','coming_ackselerator','contact_phone','organization_of_interesting','inquiry_to_ackselerator','on_moderated','benefit','link_presentation','contact_email','user_alt_id','count_people'];
     ...
     * @var array
     */
    protected $altrp_with = ['media_alt'];
    ...
    public function user_alt()
    {
        return $this->belongsTo('App\AltrpModels\user_alt', 'user_alt_id', 'id');
    }
