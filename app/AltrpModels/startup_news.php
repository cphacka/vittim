...
class startup_news extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['startup_id','title','text','media_id'];
    ...
    {
        return $this->hasMany('App\AltrpModels\comment_startup_news', 'startup_news_id', 'id');
    }
